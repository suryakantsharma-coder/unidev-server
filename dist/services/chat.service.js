...
exports.acceptChatInput = acceptChatInput;
...
const Projects = [
    {
        ...
        overview: "A high-speed cross-chain protocol designed to provide instant liquidity and automated execution across multiple blockchains, enabling seamless one-click transactions for end users.",
        ...
        why_clients_choose_this: "Showcases Unidev’s expertise in building high-performance cross-chain protocols with real-world DeFi usability.",
        is_live: false,
        tags: ["MVP"],
    },
    {
        ...
        overview: "A smart contract wallet system that provides a unified wallet address across multiple EVM-compatible blockchains using account abstraction standards.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Demonstrates Unidev’s ability to build advanced Web3 wallet infrastructure aligned with next-generation blockchain standards.",
        is_live: false,
        tags: ["MVP"],
    },
    {
        ...
        overview: "An AI-powered calling and chat automation system designed to handle customer interactions, reduce human workload, and improve response efficiency.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Highlights Unidev’s strength in delivering AI-driven automation solutions with immediate operational value.",
        is_live: false,
        tags: ["MVP"],
    },
    {
        ...
        overview: "A platform built to simplify and optimize NFT distribution by bundling multiple blockchain transactions into a single execution, significantly reducing gas fees and effort.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Demonstrates Unidev’s capability to build scalable and cost-efficient NFT infrastructure for real-world creator use cases.",
        is_live: false,
        tags: ["MVP"],
    },
    {
        ...
        overview: "A cross-platform YouTube enhancement product designed to deliver distraction-free viewing with advanced controls and performance optimization.",
        metrics: {
            active_users: "500+",
        ...
        why_clients_choose_this: "Shows Unidev’s ability to build consumer products that gain real users, not just demos.",
    ...
    },
    {
        ...
        overview: "A secure and scalable staking dApp enabling users to stake tokens, earn rewards, and manage assets across multiple chains.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Proves Unidev’s expertise in secure, user-friendly Web3 product delivery.",
    ...
    },
    {
        ...
        overview: "A high-performance real-time trading interface built for professional traders handling live market data.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Highlights Unidev’s strength in performance-critical, real-time systems.",
        is_live: false,
    },
    {
        id: "sqmt-admin",
        ...
        overview: "A MERN-based admin web application transforming manual workflows into a centralized digital system.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Shows Unidev’s capability in building reliable enterprise admin systems.",
        is_live: true,
    ...
    },
    {
        ...
        overview: "A browser extension designed to organize, filter, and streamline repetitive web workflows.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Demonstrates Unidev’s ability to build fast, practical productivity tools.",
        is_live: false,
    },
    {
        ...
        why_clients_choose_this: "Stackwarz combines addictive gameplay with blockchain rewards, offering a competitive environment where players can earn real-world value, demonstrating Unidev's expertise in Web3 game development and blockchain integration.",
        outcome: "Stackwarz successfully merges gaming with blockchain rewards, creating a fair, transparent, and engaging environment. Its real-time leaderboard and prize pool system set the stage for the future of Web3 esports-style casual gaming.",
    ...
    },
    {
        ...
        overview: "A secure Solana-based token platform enabling users to purchase FRANK tokens using USDT, USDC, or SOL with real-time pricing and full backend validations.",
        what_was_the_problem: [
        ...
        why_clients_choose_this: "Showcases Unidev’s experience building secure, scalable blockchain purchase platforms with polished UX and business-ready infrastructure.",
...
async function acceptChatInput(messages) {
    (0, logger_1.logTest)("acceptChatInput messages", messages);
    (0, intent_service_1.getConversationContext)(messages);
    // MongoDB removed for now – no persistence
    for (const msg of messages) {
        (0, logger_1.logTestLine)("acceptChatInput", `${msg.role}: ${msg.content.slice(0, 80)}${msg.content.length > 80 ? "…" : ""}`);
    }
}
async function streamChatResponse(messages, signal) {
    const openaiMessages = toOpenAIMessages(messages);
    (0, logger_1.logTest)("streamChatResponse openai messages (last 5 + system)", openaiMessages);
    const requestOptions = signal ? { signal } : {};
    const stream = await openai_1.openai.chat.completions.create({
        model: openai_1.OPENAI_MODEL,
        temperature: openai_1.OPENAI_TEMPERATURE,
        max_tokens: openai_1.OPENAI_MAX_TOKENS,
        stream: true,
...
async function saveAssistantMessage(content) {
    (0, logger_1.logTest)("saveAssistantMessage", { content });
    // MongoDB removed for now – no persistence
    const lead = extractLeadData(content);
    if (lead) {
        try {
            await (0, email_service_1.sendLeadEmail)(lead);
            (0, logger_1.logTest)("leadEmailSent", lead);
        }
        catch (err) {
            (0, logger_1.logTest)("leadEmailError", err.message);
        }
    }
}
