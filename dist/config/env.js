...
const envSchema = {
    ...
    REALTIME_ENABLE_INPUT_TRANSCRIPTION: process.env.REALTIME_ENABLE_INPUT_TRANSCRIPTION ?? '1',
    REALTIME_INPUT_TRANSCRIPTION_MODEL: process.env.REALTIME_INPUT_TRANSCRIPTION_MODEL ?? 'gpt-4o-mini-transcribe',
...
exports.env = {
    ...
    realtimeEnableInputTranscription: /^(1|true|yes)$/i.test(envSchema.REALTIME_ENABLE_INPUT_TRANSCRIPTION),
