...
import { generate, getByLead, listAll, analyze, chat } from '../controllers/aiContent.controller';
...
router.post('/analyze',           analyze);    // pattern analysis & suggestions
router.post('/chat',              chat);       // conversational assistant
